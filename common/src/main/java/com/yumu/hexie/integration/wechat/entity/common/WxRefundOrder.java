...
public class WxRefundOrder implements Serializable {
	...
	private static final long serialVersionUID = 4019534018934847696L;
	/*	<xml>
	...
	public boolean isRefundSuccess() {
		return "SUCCESS".equalsIgnoreCase(refund_status_0);
	}
	public boolean isRefundFail() {
		return "FAIL".equalsIgnoreCase(refund_status_0)
				||"CHANGE".equalsIgnoreCase(refund_status_0)
				||"NOTSURE".equalsIgnoreCase(refund_status_0);
	}
	public boolean isRefundProcessing() {
		return "PROCESSING".equalsIgnoreCase(refund_status_0);
	}
